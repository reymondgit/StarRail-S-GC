...
namespace config {
	...
	void Save() {
		const json j = Config
		{
			...
			globals::world::dump_enemys,
			globals::world::peeking,
			globals::world::auto_dialogue,
			globals::world::mouse_mode,
			globals::world::invisibility,

			globals::battle::speed_hack,
			globals::battle::battle_speed,
			globals::battle::auto_battle_unlock,
			globals::battle::force_battle,

			globals::other::fps_unlock,
			globals::other::fps
		};
